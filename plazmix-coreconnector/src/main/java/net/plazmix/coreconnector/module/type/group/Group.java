...
public enum Group {
     ...
     */
    QA(10, ChatColor.GOLD, "M", "Тестер", "§6§lQA§6", "§7"),
    MEDIA(11, ChatColor.RED, "M", "Медиа", "§c§lMEDIA§c", "§f"),
    MEDIA_PLUS(12, ChatColor.RED, "L", "Медиа +", "§c§lMEDIA§c", "§f"),
    BUILDER(13, ChatColor.DARK_GREEN, "K", "Строитель", "§2§lBUILD§2", "§f"),
    SR_BUILDER(14, ChatColor.DARK_GREEN, "J", "Ст.Строитель", "§2§lSR.BUILD§2", "§f"),

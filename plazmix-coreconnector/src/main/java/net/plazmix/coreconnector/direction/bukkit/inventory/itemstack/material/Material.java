package net.plazmix.coreconnector.direction.bukkit.inventory.itemstack.material;
...
public enum Material {
    ...
    public static final Material[] ALL_TYPES = values();

    @Getter
    public final int materialId;


    Material(int materialId, int xz) {
        this(materialId);
    }

    Material(int materialId, int xz, int xz2) {
        this(materialId);
    }
}
